...
const CaregiverEditProfile = () => {
  ...
  console.log(
    'caregiverProfile?.characteristics?.religion',
    caregiverProfile?.characteristics?.religion
  );
      ...
      <ThemedView style={styles.container}>
        ...
        <ScrollView style={styles.scrollView}>
            ...
            <TouchableOpacity onPress={handleImagePick}>
              <View style={styles.profilePhotoContainer}>
                {profilePicture?.path ? (
                  ...
                  <View
                    style={[styles.profilePhoto, styles.defaultProfilePhoto]}
                  >
                    <Entypo name='user' size={40} color='#261D2A' />
                  </View>
                )}
                <ThemedText style={styles.photoText}>
                  Tap on photo to edit
                </ThemedText>
              </View>
            </TouchableOpacity>
          </View>
            ...
            <View style={styles.promptsContainer}>
              {caregiverProfile?.prompts?.map((prompt) => (
                <View key={prompt.id} style={styles.promptBox}>
                  <ThemedText style={styles.promptQuestion}>
                    {prompt.title}
                  </ThemedText>
                  <ThemedText style={styles.promptAnswer}>
                    {prompt.answer}
                  </ThemedText>
          ...
          <View style={styles.sectionContainer}>
            ...
            <InfoPill label={getReligion()} locked />
          </View>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={[styles.personalityContainer, { flexWrap: 'wrap' }]}>
              {caregiverProfile?.characteristics?.personalities?.map(
                (personality, index) => (
                  <InfoPill key={index} label={personality} locked />
                )
              )}
            </View>
          </View>
