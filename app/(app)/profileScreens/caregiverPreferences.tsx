          ...
          <View style={styles.container}>
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.payTypeContainer}>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.payTypeButton,
                      caregiverProfileData?.payment_info?.type ===
                        'Salary Base' && styles.selectedPayType,
                    ]}
                  ...
                  >
                    ...
                    <ThemedText
                      style={[
                        styles.payTypeText,
                        caregiverProfileData?.payment_info?.type ===
                          'Salary Base' && styles.selectedPayTypeText,
                      ]}
                    >
                      Salary Base
                    </ThemedText>
              ...
              {caregiverProfileData?.payment_info?.type === 'Hourly' ? (
                <View style={styles.subSection}>
                  ...
                  <View style={styles.pillContainer}>
                    <InfoPill
                      icon={'⌛'}
                      label={`$${caregiverProfileData?.payment_info?.hourly_min} - $${caregiverProfileData?.payment_info?.hourly_max}`}
                    />
                  </View>
                  <View style={styles.sliderContainer}>
                    ...
                    <MultiSlider
                      values={[
                        caregiverProfileData?.payment_info?.hourly_min,
                        caregiverProfileData?.payment_info?.hourly_max,
                      ]}
                      min={15}
                      max={45}
                      step={1}
                ...
                <View style={styles.subSection}>
                  ...
                  <View style={styles.pillContainer}>
                    <InfoPill
                      icon={'⌛'}
                      label={`${caregiverProfileData?.payment_info?.salary}/Year`}
                    />
                  </View>
                </View>
              )}
            ...
            <View style={[styles.section, styles.experienceSection]}>
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  {caregiverProfileData?.experience_with_disabilities?.disabilities?.map(
                    (arrangement: string) => (
              ...
              <View style={styles.subSection}>
                <View style={styles.lockedContainer}>
                  <View style={styles.lockedContent}>
                    ...
                    <View style={styles.pillContainer}>
                      {caregiverProfileData?.experience_with_pets?.pets?.map(
                        (pet: string) => (
              ...
              <View style={styles.subSection}>
                <View style={styles.lockedContainer}>
                  <View style={styles.lockedContent}>
                    ...
                    <InfoPill
                      // icon={'🏠'}
                      label={caregiverProfileData?.arrangement_type}
                    />
                  </View>
                  <Image
                    source={require('@/assets/icons/lock.png')}
              ...
              <View style={styles.subSection}>
                <View style={styles.lockedContainer}>
                  <View style={styles.lockedContent}>
                    ...
                    <InfoPill
                      icon={'📅'}
                      label={caregiverProfileData?.job_commitment?.commitment}
                    />
                  </View>
                  <Image
                    source={require('@/assets/icons/lock.png')}
              ...
              <View style={styles.subSection}>
                <View style={styles.lockedContainer}>
                  <View style={styles.lockedContent}>
                    <ThemedText style={styles.heading}>
                      My Certification/Requirement
                    </ThemedText>
                    <View style={styles.pillContainer}>
                      {caregiverProfileData?.abilities_and_certifications?.abilities?.map(
                        (certification: string) => (
                          <InfoPill key={certification} label={certification} />
                        )
                      )}
                      {caregiverProfileData?.abilities_and_certifications?.certifications?.map(
                        (certification: string) => (
                          <InfoPill key={certification} label={certification} />
                        )
                      )}
              ...
              <View style={styles.subSection}>
                <View style={styles.lockedContainer}>
                  <View style={styles.lockedContent}>
                    ...
                    <View style={styles.pillContainer}>
                      {caregiverProfileData?.required_benfits?.map(
                        (benefit: string) => (
            ...
            <View style={[styles.section, styles.householdSection]}>
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  {caregiverProfileData?.responsibilities?.household_responsibilities?.map(
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  {caregiverProfileData?.characteristics?.rules?.map(
                    (rule: string) => (
                      <InfoPill key={rule} label={rule} />
                    )
                  )}
                  {caregiverProfileData?.childcare_philosophies?.map(
                    (philosophy: string) => (
