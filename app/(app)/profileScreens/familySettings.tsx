                ...
                <ScrollView contentContainerStyle={{ paddingBottom: 160 }}>
                    <ThemedView style={styles.container}>
                        <View style={styles.section}>
                            ...
                            <View>
                                <View style={styles.flexContainer}>
                                    <ThemedText style={styles.heading}>Show Last Active Status</ThemedText>
                                    <Switch
                                        trackColor={{ false: "#D7D7DC", true: '#EB4430' }}
                                        thumbColor={'#ffffff'}
                                        ios_backgroundColor="#D7D7DC"
                        ...
                        <View style={styles.section}>
                            <ThemedText style={styles.text}>For Support Please Email </ThemedText>
                            <ThemedText style={styles.heading}>support@karamacare.com</ThemedText>
                        </View>
