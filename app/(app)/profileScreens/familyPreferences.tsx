  ...
  return (
    <SafeAreaView>
      <ThemedView>
          ...
          <View style={styles.container}>
                ...
                <View style={styles.payTypeContainer}>
                  <TouchableOpacity
                    style={[
                      ...
                      familyProfileData?.extra_info?.payment_info?.type
                        ?.toLowerCase()
                        .includes('hourly') && styles.selectedPayType,
                    ]}
                  ...
                  >
                    ...
                    <ThemedText
                      style={[
                        ...
                        familyProfileData?.extra_info?.payment_info?.type
                          ?.toLowerCase()
                          .includes('hourly') && styles.selectedPayTypeText,
                      ]}
                    >
                      Hourly
                    </ThemedText>
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      familyProfileData?.extra_info?.payment_info?.type
                        ?.toLowerCase()
                        .includes('salary') && styles.selectedPayType,
                    ]}
                  ...
                  >
                    ...
                    <ThemedText
                      style={[
                        ...
                        familyProfileData?.extra_info?.payment_info?.type
                          ?.toLowerCase()
                          .includes('salary') && styles.selectedPayTypeText,
                      ]}
                    >
                      Salary Base
                    </ThemedText>
                ...
                {familyProfileData?.extra_info?.payment_info?.type
                  ...
                  <View style={styles.subSection}>
                    ...
                    <View style={styles.pillContainer}>
                      <InfoPill
                        icon={'⌛'}
                        label={`$${familyProfileData?.extra_info?.payment_info?.hourly_min} - $${familyProfileData?.extra_info?.payment_info?.hourly_max}`}
                      />
                    </View>
                    <View style={styles.sliderContainer}>
                      ...
                      <MultiSlider
                        values={[
                          familyProfileData?.extra_info?.payment_info
                            ?.hourly_min,
                          familyProfileData?.extra_info?.payment_info
                            ?.hourly_max,
                        ]}
                  ...
                  <View style={styles.subSection}>
                    <View>
                      <TextInput
                        ...
                        placeholder={
                          familyProfileData?.extra_info?.payment_info?.salary
                        }
                      />
                    </View>
                  </View>
            ...
            <View style={styles.section}>
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  <InfoPill
                    label={
                      familyProfileData?.caregiver_preference?.job_commitment
                        ?.start_date
                    }
                  />
                </View>
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  {familyProfileData?.caregiver_preference?.caregiver_types?.map(
                    (type: string) => {
              ...
              <View style={styles.subSection}>
                <View style={styles.headerStyle}>
                  <ThemedText style={styles.heading}>
                    Should be an age range of
                  </ThemedText>
                </View>
                <View style={styles.pillContainer}>
                  <InfoPill
                    label={
                      familyProfileData?.caregiver_preference?.age_preference
                        ?.age_group
                    }
                  />
                </View>
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  <InfoPill
                    label={familyProfileData?.caregiver_preference?.experience}
                  />
                </View>
              </View>
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  <InfoPill
                    label={
                      familyProfileData?.caregiver_preference?.availability
                    }
                  />
                </View>
              </View>
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  <InfoPill
                    label={
                      familyProfileData?.caregiver_preference?.arrangement_type
                    }
                  />
                </View>
              </View>
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  {familyProfileData?.caregiver_preference?.requirements?.requirements?.map(
                    (work) => {
            ...
            <View style={styles.section}>
              ...
              <View style={styles.subSection}>
                ...
                <View style={styles.pillContainer}>
                  {familyProfileData?.extra_info?.benefits?.benefits?.map(
                    (benefit) => {
              ...
              >
                <ThemedText style={styles.heading}>
                  Anything else you'd like caregivers to know?{' '}
                </ThemedText>
                <View style={styles.pillContainer}>
                  <ThemedText style={styles.sectionText2}>
                    {familyProfileData?.extra_info?.more_information}
                  </ThemedText>
                </View>
              </View>
            </View>
        ...
        <ComingSoonModal visible={isModalVisible} onClose={handleCloseModal} />
      </ThemedView>
    </SafeAreaView>
  );
};
